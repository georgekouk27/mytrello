...
import gr.georkouk.mytrello.databinding.ItemCardSelectedMemberBinding
import gr.georkouk.mytrello.models.SelectedMembers
...
open class CardMemberListItemsAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return MyViewHolder(
            ItemCardSelectedMemberBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        )
    }
    ...
    class MyViewHolder(binding: ItemCardSelectedMemberBinding) : RecyclerView.ViewHolder(binding.root){
        var ivAddMember = binding.ivAddMember
        var ivSelectedMemberImage = binding.ivSelectedMemberImage
    }
